...
export function MeteorCard() {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="relative w-full max-w-xl max-h-xl">
        ...
        <div className="relative flex h-full flex-col items-start justify-end overflow-hidden rounded-2xl border border-gray-800 bg-gray-900 px-4 py-8 shadow-xl">
          ...
          <h1 className="relative z-50 mb-4 text-sm md:text-base lg:text-2xl font-bold text-white">
            Meteors because they&apos;re cool
          </h1>

          <p className="relative z-50 mb-4 text-sm md:text-base lg:text-lg font-normal text-slate-500">
